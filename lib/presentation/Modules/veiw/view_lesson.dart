...
//                 // Cup colors للثلاثة الأوائل فقط
...
//   // تعديل بسيط في _buildCustomLessonItem لتستقبل cupColor
          ...
          onReady: () {
            ...
            if (mounted && !_isDisposing) {
              ...
              _questionCheckTimer = Timer.periodic(const Duration(seconds: 1), (
                ...
                if (_playerKey != null && _isPlayerReady && mounted) {
                  final currentSeconds =
                      await _playerKey!.currentState?.getCurrentTime() ?? 0;
                  _checkForQuestions(currentSeconds);
                }
              });
            }
