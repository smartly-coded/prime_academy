...
//                       return _buildRankingTableWithPagination(pagedRankings);
//                     }
...
//   Widget _buildRankingTableWithPagination(List<RankingModel> pagedRankings) {
//     return Container(
...
//                 topLeft: Radius.circular(totalPages > 1 ? 0 : 15),
//                 topRight: Radius.circular(totalPages > 1 ? 0 : 15),
//               ),
//             ),
//             child: Row(
//               children: [
...
//           }).toList(),
//           onChanged: onChanged,
//           dropdownColor: const Color(0xFF161c29),
//         ),
//       ),
//     );
//   }
