...
class buildTextWithBorder extends StatefulWidget {
  ...
  @override
  State<buildTextWithBorder> createState() =>
      _buildTextWithBorderState();
}

class _buildTextWithBorderState
    extends State<buildTextWithBorder> {
  bool isFlipped = false;

  @override
  Widget build(BuildContext context) {
    final width =
        widget.containerWidth ?? MediaQuery.of(context).size.width * 0.5;
        ...
        children: [
          SizedBox(
            ...
            child: AnimatedContainer(
              ...
              child: Container(
                height: widget.containerHeight ?? 54,
                padding:
                ...
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize:
                          widget.fontSize ?? _getResponsiveFontSize(context),
