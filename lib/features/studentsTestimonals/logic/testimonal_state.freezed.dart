...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TestimonalState<T>);
}
...
/// @nodoc
class $TestimonalStateCopyWith<T,$Res>  {
$TestimonalStateCopyWith(TestimonalState<T> _, $Res Function(TestimonalState<T>) __);
}


/// Adds pattern-matching-related methods to [TestimonalState].
extension TestimonalStatePatterns<T> on TestimonalState<T> {
...
class _Initial<T> implements TestimonalState<T> {
  const _Initial();
...
@override
String toString() {
  return 'TestimonalState<$T>.initial()';
}
...
class Loading<T> implements TestimonalState<T> {
  const Loading();
...
@override
String toString() {
  return 'TestimonalState<$T>.loading()';
}
...
class Success<T> implements TestimonalState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of TestimonalState
...
@override
String toString() {
  return 'TestimonalState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $TestimonalStateCopyWith<T, $Res> {
...
class Error<T> implements TestimonalState<T> {
...
@override
String toString() {
  return 'TestimonalState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $TestimonalStateCopyWith<T, $Res> {
