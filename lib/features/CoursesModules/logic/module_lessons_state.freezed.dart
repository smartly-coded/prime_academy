...
part of 'module_lessons_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ModuleLessonsState<T>);
}
...
/// @nodoc
class $ModuleLessonsStateCopyWith<T,$Res>  {
$ModuleLessonsStateCopyWith(ModuleLessonsState<T> _, $Res Function(ModuleLessonsState<T>) __);
}


/// Adds pattern-matching-related methods to [ModuleLessonsState].
extension ModuleLessonsStatePatterns<T> on ModuleLessonsState<T> {
...
class _Initial<T> implements ModuleLessonsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ModuleLessonsState<$T>.initial()';
}
...
class Loading<T> implements ModuleLessonsState<T> {
  const Loading();
...
@override
String toString() {
  return 'ModuleLessonsState<$T>.loading()';
}
...
class Success<T> implements ModuleLessonsState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of ModuleLessonsState
...
@override
String toString() {
  return 'ModuleLessonsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ModuleLessonsStateCopyWith<T, $Res> {
...
class Error<T> implements ModuleLessonsState<T> {
...
@override
String toString() {
  return 'ModuleLessonsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ModuleLessonsStateCopyWith<T, $Res> {
