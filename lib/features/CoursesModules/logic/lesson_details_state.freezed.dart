...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LessonDetailsState<T>);
}
...
/// @nodoc
class $LessonDetailsStateCopyWith<T,$Res>  {
$LessonDetailsStateCopyWith(LessonDetailsState<T> _, $Res Function(LessonDetailsState<T>) __);
}


/// Adds pattern-matching-related methods to [LessonDetailsState].
extension LessonDetailsStatePatterns<T> on LessonDetailsState<T> {
...
class _Initial<T> implements LessonDetailsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'LessonDetailsState<$T>.initial()';
}
...
class Loading<T> implements LessonDetailsState<T> {
  const Loading();
...
@override
String toString() {
  return 'LessonDetailsState<$T>.loading()';
}
...
class Success<T> implements LessonDetailsState<T> {
...
@override
String toString() {
  return 'LessonDetailsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $LessonDetailsStateCopyWith<T, $Res> {
...
class Error<T> implements LessonDetailsState<T> {
...
@override
String toString() {
  return 'LessonDetailsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $LessonDetailsStateCopyWith<T, $Res> {
