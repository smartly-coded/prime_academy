...
part of 'mark_answered_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MarkAnsweredState<T>);
}
...
/// @nodoc
class $MarkAnsweredStateCopyWith<T,$Res>  {
$MarkAnsweredStateCopyWith(MarkAnsweredState<T> _, $Res Function(MarkAnsweredState<T>) __);
}


/// Adds pattern-matching-related methods to [MarkAnsweredState].
extension MarkAnsweredStatePatterns<T> on MarkAnsweredState<T> {
...
class _Initial<T> implements MarkAnsweredState<T> {
  const _Initial();
...
@override
String toString() {
  return 'MarkAnsweredState<$T>.initial()';
}
...
class Loading<T> implements MarkAnsweredState<T> {
  const Loading();
...
@override
String toString() {
  return 'MarkAnsweredState<$T>.loading()';
}
...
class Success<T> implements MarkAnsweredState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of MarkAnsweredState
...
@override
String toString() {
  return 'MarkAnsweredState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $MarkAnsweredStateCopyWith<T, $Res> {
...
class Error<T> implements MarkAnsweredState<T> {
...
@override
String toString() {
  return 'MarkAnsweredState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $MarkAnsweredStateCopyWith<T, $Res> {
