...
part of 'student_preview_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StudentPreviewState<T>);
}
...
/// @nodoc
class $StudentPreviewStateCopyWith<T,$Res>  {
$StudentPreviewStateCopyWith(StudentPreviewState<T> _, $Res Function(StudentPreviewState<T>) __);
}


/// Adds pattern-matching-related methods to [StudentPreviewState].
extension StudentPreviewStatePatterns<T> on StudentPreviewState<T> {
...
class _Initial<T> implements StudentPreviewState<T> {
  const _Initial();
...
@override
String toString() {
  return 'StudentPreviewState<$T>.initial()';
}
...
class Loading<T> implements StudentPreviewState<T> {
  const Loading();
...
@override
String toString() {
  return 'StudentPreviewState<$T>.loading()';
}
...
class Success<T> implements StudentPreviewState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of StudentPreviewState
...
@override
String toString() {
  return 'StudentPreviewState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $StudentPreviewStateCopyWith<T, $Res> {
...
class Error<T> implements StudentPreviewState<T> {
...
@override
String toString() {
  return 'StudentPreviewState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $StudentPreviewStateCopyWith<T, $Res> {
